    ...
    <body>
            ...
            <div class="shop-box">
                ...
                <div class="menu_area">
                    <div class="container">
                        <div class="row">
                            @foreach ($list_category as $cate)
                                <div class="col-12 item" data-id="{{ $cate->id }}">
                                    <div class="row">
                                        <div class="col-md-12">
        ...
        <div class="footer">
            <div class="footer-box">
                <div class="copyright">
                    <p>Copyright &copy; 2024 | Made With Love by <a href="https://www.facebook.com/DgytosSoftware/" target="_blank">Dgytos</a></p>
                </div>
            </div>
        </div>
            ...
            $(document).ready(function(){
                ...
                $('.category-btn').on('click', function(){
                    ...
                    if(filterValue === '*') {
                        ...
                        // تصفية البطاقات بناءً على id
                        $grid.isotope({ filter: '[data-id="' + filterValue + '"]' });
                    }
